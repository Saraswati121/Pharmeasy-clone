  ...
  return (
    <div>
        ...
        <div className={styles.navbar_part}>
          ...
          <div className={styles.navbar_part2}>
            <div className={`${styles.icons} ${styles.logo_part_background}`}>
              ...
              <div className={styles.text_part}><a href="https://apps.apple.com/IN/app/id982432643?mt=8">Download Now</a></div>
            </div>
            <div>
              <div className={styles.logo_part}>
                <svg
      ...
      <div className={styles.small_nav}>
        ...
        data.map((el)=>(
          <Link to={el.link} className={styles.link}>{el.name}</Link>
        ))
